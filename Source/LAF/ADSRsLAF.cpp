                                          ...
                                          const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& slider)
{
    ...
    g.setColour (mainSliderColour_.darker(0.075f).withSaturation (b_ * 0.9f));
    ...
    //==============================================================================
                                //Coloured Covers
    //==============================================================================
    g.setColour (mainSliderColour_.withSaturation (b_ * 0.9f));
   ...
   /* g.setColour (mainSliderColour.darker(0.075f));
    ...
    g.setColour (mainSliderColour_.withSaturation (b_ * 0.5f));
